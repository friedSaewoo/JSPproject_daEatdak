...
<head>
    ...
    <title>다잇닭</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/admin/css/adminProductRegist.css">
                    ...
                    <div class="totalProdList">
                        <div class="registerPage">
                            ...
                            <div style="width: 350px; height: 350px;">
                                ...
                                <input type="file" id="image" accept="image/*" onchange="setThumbnail(event);" style="width: 180px;" />
